...
class HarnessReviewTest(unittest.TestCase):
    ...
    def test_print_stream_returns_only_text_after_final_tool(self):
        events = [
            ...
            {"contentBlockStart": {"start": {"toolUse": {"name": "shell"}}}},
    ...
    def test_parse_events_preserves_unknown_service_errors(self):
        events = [{"validationException": {"message": "invalid request"}}]

        self.assertEqual(
            list(harness_review.parse_events(events)),
